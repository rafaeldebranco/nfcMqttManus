...
- **Protocolo MQTT**: Publicação de leituras via PubSubClient.
...
- `MqttManager`: Gerencia a conexão com o broker e publicação de mensagens.
...
## Como usar
1. Edite o arquivo `data/config.json` com suas credenciais.
